...
void Tank::walk_gl(bool picking) const
{
  ...
  glTexCoord2f(1.0f, 0.0f);
  glVertex3f(1.1f, 0.0f, -0.4f);
  glTexCoord2f(1.0f, 1.0f);
  glVertex3f(1.1f, 1.0f, -0.4f);
  glTexCoord2f(0.0f, 1.0f);
  glVertex3f(0.9f, 1.0f, -0.4f);
  glTexCoord2f(1.0f, 0.0f);
  glVertex3f(0.9f, 0.0f, -0.6f);
  glTexCoord2f(1.0f, 1.0f);
  glVertex3f(0.9f, 1.0f, -0.6f);
  glTexCoord2f(0.0f, 1.0f);
  glVertex3f(1.1f, 1.0f, -0.6f);
  glTexCoord2f(0.0f, 0.0f);
  glVertex3f(1.1f, 0.0f, -0.6f);
  glTexCoord2f(0.0f, 1.0f);
  glVertex3f(0.9f, 1.0f, -0.6f);
  glTexCoord2f(0.0f, 0.0f);
  glVertex3f(0.9f, 1.0f, -0.4f);
